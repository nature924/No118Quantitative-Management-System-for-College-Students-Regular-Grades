                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengVideo" label="课程视频" prop="kechengVideo">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.kechengVideo?$base.url+ruleForm.kechengVideo:''"
                            @change="kechengVideoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengVideo" label="课程视频" prop="kechengVideo">
                            <video :src="$base.url+ruleForm.kechengVideo" width="100" height="100" controls="controls">
                            </video>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengFile" label="课程文件" prop="kechengFile">
                        <file-upload
                                tip="点击上传课程文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.kechengFile?$base.url+ruleForm.kechengFile:''"
                                @change="kechengFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengFile" label="课程文件" prop="kechengFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.kechengFile"  >课程文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   kechengFile: [
                              { required: true, message: '课程文件不能为空', trigger: 'blur' },
                          ],
                   xuekeTypes: [
