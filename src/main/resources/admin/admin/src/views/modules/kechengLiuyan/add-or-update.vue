        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='kecheng'">
                    <el-form-item class="select" v-if="type!='info'"  label="课程资源" prop="kechengId">
                        <el-select v-model="ruleForm.kechengId" :disabled="ro.kechengId" filterable placeholder="请选择课程资源" @change="kechengChange">
                            <el-option
