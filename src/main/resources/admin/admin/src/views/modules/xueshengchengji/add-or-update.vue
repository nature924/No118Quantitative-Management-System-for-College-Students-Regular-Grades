        ...
        <el-form
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="时间" prop="xueshengchengjiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.xueshengchengjiTime"
                                type="date"
                                placeholder="时间"
                                :disabled="ro.xueshengchengjiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xueshengchengjiTime" label="时间" prop="xueshengchengjiTime">
                            <span v-html="ruleForm.xueshengchengjiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学科" prop="xuekeTypes">
                        <el-select v-model="ruleForm.xuekeTypes" :disabled="ro.xuekeTypes" placeholder="请选择学科">
                            <el-option
                                v-for="(item,index) in xuekeTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学科" prop="xuekeValue">
                        <el-input v-model="ruleForm.xuekeValue"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueke_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xuekeTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.xueshengchengjiContent = _this.ruleForm.xueshengchengjiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.xueshengchengjiContent = this.ruleForm.xueshengchengjiContent.replaceAll(this.$base.url,"");
                        this.$http({
